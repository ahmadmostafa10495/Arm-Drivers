...
#define SCB_APINT_REG       (*((volatile uint32*)0xE000ED0C))
typedef struct
{
    uint32 B0:1;
    uint32 B1:1;
...
#define SysCtl_RCC_R    (*((volatile union_RCC_t *)0x400FE060))
#define SysCtl_RCC2_R   (*((volatile union_RCC2_t *)0x400FE070))
/*===========================================================*
 * GPIO REGISTERS                                            *
 *========================================================== */
typedef struct
